  ...
  return (
    ...
    <div class="navigation__page-container">
        <div class="navigation__page-left">
            ...
            <div class="navigation__page-info">
                <div class="info">
                    <p class="bold">240k+</p>
                    <p class="small">TotalSale</p>

                </div>
                <div class="info">
                    <p class="bold">100k+</p>
                    <p class="small">Auctions</p>

                </div>
                <div class="info">
                    <p class="bold">240k+</p>
                    <p class="small">Artists</p>

                </div>
            </div>

        </div>
        <div class="navigation__page-right navigation__page-right__nonesecond">
            <img width="100%" height="100%"
                src="https://cdn.animaapp.com/projects/6357ce7c8a65b2f16659918c/files/heroanimationtransparentbck-2.gif"/>
        </div>
    </div>
